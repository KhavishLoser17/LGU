    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Today: {{ \Carbon\Carbon::parse($today)->format('F j, Y') }}</p>
                </div>
                <div class="flex space-x-4">
                    <a href="{{ route('attendance.generate-qr') }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-600">Early</p>
                        <p class="text-2xl font-bold text-yellow-600">{{ $stats['early'] }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Today's Attendance</h2>
            </div>
            <div class="overflow-x-auto">
                ...
                @else
                    <div class="p-12 text-center">
                        ...
                        <p class="text-gray-400 text-sm mt-2">Generate a QR code to start tracking attendance</p>
                    </div>
                @endif
            </div>
        </div>
